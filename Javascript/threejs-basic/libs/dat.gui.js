...
dat.GUI = dat.gui.GUI = function (e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
    ...
    '<code>localStorage</code> on exit.\n\n    ' +
    '<div id="dg-local-explain">The values saved to ' +
    '<code>localStorage</code> will\n      override those passed to ' +
    '<code>dat.GUI</code>\'s constructor. This makes it\n      easier to work incrementally, but ' +
    '<code>localStorage</code> is fragile,\n      and your friends may not see the same values you do.\n      \n    ' +
    '</div>\n    \n  ' +
    '</div>\n\n</div>',
    ...
    dat.controllers.ColorController = function (e, a, b, d, f) {
        ...
        var k = function (e, n) {
            ...
            function t(b) {
                b.preventDefault();
                var d = a.getWidth(s.__saturation_field), c = a.getOffset(s.__saturation_field),
